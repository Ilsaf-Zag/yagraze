            ...
            <div class="align-middle inline-block min-w-full">
                ...
                >
                    <div class="py-2 flex space-x-4">
                        <router-link :to="{name:'admin.illustrations.create'}"
                                     class="bg-green-600 text-sm  hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                            Создать
                        </router-link>
                        <router-link :to="{name:'admin.illustrations.sort'}"
                    ...
                    <table class="w-full divide-y divide-gray mt-4">
                        ...
                        <tr v-for="illustration in illustrations.data" :key="illustration.id">
                            ...
                            <td class=" px-4 py-4 sm:px-2 whitespace-nowrap relative ">
                                <div class="group text-sm font-medium inline-block">
                                    <router-link :to="{name:'admin.illustrations.edit',params:{id:illustration.id}}"
                            ...
                            <td class=" px-4 py-4 sm:px-2 whitespace-nowrap relative">
                                <div class="group text-sm font-medium inline-block">
                                    <button @click="deleteIllustration(illustration.id)"
                    ...
                    <div class="flex justify-center mt-5 ">
                        <TailwindPagination
                            :data="illustrations"
                            @pagination-change-page="getIllustrations"
