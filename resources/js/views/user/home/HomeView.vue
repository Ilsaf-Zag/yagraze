        ...
        <section class="pt-24">
            <div class="relative">
                ...
                <div v-if="largerThanSm" class="absolute -bottom-1/2 w-60 -z-10 lg:w-40 lg:-bottom-1/4">
                    <img src="../../../../assets/images/claims/pit.svg">
                </div>
            </div>
        </section>
                ...
                <div
                    ...
                    <Splide
                        ...
                        <SplideTrack class="text-3xl leading-[45px]">
                            <SplideSlide class="overflow-y-auto overflow-x-hidden" v-for="review in reviews" :key="review.id">
                                {{ review.text }}
                            </SplideSlide>
                        </SplideTrack>
                        <div
...
axios.get('/api/admin/settings', {params: ['infoAboutDesigner']})
    .then(res => {
        if (res.data) {
